                                ...
                                <form class="auth-register-form mt-2" action="{{route('signup')}}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="register-username" name="userName"
                                            placeholder="Nhập tên đăng nhập" aria-describedby="register-username"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="fullName" name="fullName"
                                            placeholder="Nhập họ tên" aria-describedby="fullName" tabindex="1"
                                            autofocus />
                                    ...
                                    <div class="mb-1">
                                        <label for="register-rePassword" class="form-label">Nhập lại mật khẩu</label>

                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge"
                                                id="register-rePassword" name="rePassword"
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="register-rePassword" tabindex="3" />
                                            <span class="input-group-text cursor-pointer"><i
                                                    data-feather="eye"></i></span>
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="form-check my-50">
                                            <input type="radio" id="validationRadio3" name="sex"
                                                class="form-check-input" value="Nam"
                                                {{ old('sex') == 'Nam' ? 'checked' : ''}}>
                                            <label class="form-check-label" for="validationRadio3">Nam</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="validationRadio4" name="sex"
                                                class="form-check-input" value="Nữ"
                                                {{ old('sex') == 'Nữ' ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="SDT" name="SDT"
                                            placeholder="0852348684" aria-describedby="SDT" tabindex="2" />
                                        @if($errors->has('SDT'))
                                        <span class="error-message text-danger">*
                                    ...
                                    <div class="mb-1">
                                        <label class="d-block form-label" for="validationBioBootstrap">Địa
                                            chỉ</label>
                                        <textarea class="form-control" id="validationBioBootstrap" name="address"
                                            rows="3"></textarea>
